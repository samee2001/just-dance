                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="footer-item d-flex flex-column">
                        <div class="footer-item">
                            <h4 class="text-white mb-4">Just Dance</h4>
                            <p class="text-white mb-3">Welcome to Just Dance Dancing Academy, where passion meets rhythm. We offer a variety of dance classes for all ages and skill levels in a fun, supportive environment.</p>
                            <div class="d-flex">
