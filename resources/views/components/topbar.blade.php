    ...
    <div class="row gx-0 align-items-center" style="height: 45px;">
        <div class="col-lg-8 text-center text-lg-start mb-lg-0">
            <div class="d-flex flex-wrap">
                <a href="#" class="text-light me-4"><i class="fas fa-map-marker-alt text-primary me-2"></i>123 Rhythm Street, Colombo</a>
                <a href="#" class="text-light me-4"><i class="fas fa-phone-alt text-primary me-2"></i>+94 11 234 5678</a>
                <a href="#" class="text-light me-0"><i class="fas fa-envelope text-primary me-2"></i>info@justdance.lk</a>
            </div>
        </div>
